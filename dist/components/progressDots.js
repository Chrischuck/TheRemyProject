...
function (_React$Component) {
  _inherits(ProgressDots, _React$Component);
  ...
  function ProgressDots() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDots", function () {
      ...
      for (var i = 0; i < count; i++) {
        dots.push(React.createElement("span", {
          ...
          className: "dot ".concat(i <= step ? 'dot-filled' : '')
        }));
      }
